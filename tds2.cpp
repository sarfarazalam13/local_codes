...
a:      //goto statemnt
cout<<"Do you want computer generated Truths and Dares?"<<"\n"<<"to end the game press F";
cin>>cho;
switch(cho)
{
case 'f':goto b;
...
cout<<"\n"<<"For next round press Y and hit enter or to exit this mode press any key  ";
cin>>choice;
}
goto a;
}
